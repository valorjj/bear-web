...
export const ko: Record<TranslationKey, string> = {
  ...
  'editor.loadError': '노트를 열지 못했습니다.',
  'editor.loadError.retry': '페이지 새로고침',
  ...
  'editor.link.address': '링크 주소',
  'editor.link.placeholder': 'https://example.com',
  'editor.link.add': '링크 추가',
  'editor.link.save': '링크 저장',
  ...
  'editor.linkAutocomplete.headingListLabel': '제목 링크',
  'editor.linkAutocomplete.headingEmpty': '일치하는 제목이 없습니다',
