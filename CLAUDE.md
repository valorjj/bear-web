...
3216 unit tests pass and 124 skip (the server integration tests, which skip
when `TEST_DATABASE_URL` is unset; 71 renderer tests sit behind
`npm run test:pdf`), 315 end-to-end tests pass and 1 skips. `main` is always green and
auto-deploys.
...
**The rulings live in `docs/rulings/`, not here.** 595 bullets across 13 files,
